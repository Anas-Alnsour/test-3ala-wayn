...
<head>
    ...
    <style>
        ...
        body {
            /* خلفية بني داكن جداً دافئة تعكس لون الصخر والقهوة */
        ...
        .jordan-triangle {
            ...
            height: 100%;
            width: 80px;
            background-color: #CE1126; /* أحمر العلم الأردني */
            z-index: 1001;
        }
...
<body @mousemove="updateGlow($event)">
    ...
    <header class="fixed top-0 w-full z-50 transition-all duration-500 mt-[6px]" :class="scrolled ? 'bg-[#140b08]/90 backdrop-blur-xl border-b border-[#3a251c] py-3 shadow-lg' : 'bg-transparent py-5'">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center gap-8">
                ...
                <button @click="toggleLang()" class="w-10 h-10 rounded-full border border-[#3a251c] bg-[#1f130e]/50 hover:border-[#c17551] text-gray-300 hover:text-[#c17551] flex items-center justify-center font-bold transition-colors cursor-pointer shadow-inner">
                    ...
                    <div x-data="{ isGenerating: false, generated: false }">
                        ...
                        <div x-show="generated" x-transition.duration.500ms class="mt-8 bg-black/40 p-6 rounded-2xl border border-[#c17551]/30">
                            ...
                            <div class="space-y-4 border-l-2 rtl:border-l-0 rtl:border-r-2 border-[#3a251c] ltr:pl-4 rtl:pr-4">
                                ...
                                <div><span class="text-white font-bold">01:00 PM</span> - <span class="text-gray-400" x-text="language === 'ar' ? 'غداء في مطعم هاشم' : 'Lunch at Hashem Restaurant'"></span></div>
        ...
        <section id="currency" class="py-24 relative z-10">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div class="max-w-lg mx-auto glass-card rounded-3xl p-8 text-center" x-data="{ usd: 100, jod: 70.92 }">
                    <div class="flex items-center justify-between bg-black/40 border border-[#3a251c] rounded-2xl p-4 mb-4 focus-within:border-[#c17551] transition-colors">
                        <span class="text-2xl font-black text-gray-400">USD</span>
                        <input type="number" x-model="usd" @input="jod = (usd / 1.41).toFixed(2)" class="bg-transparent border-none text-right rtl:text-left text-3xl font-black text-white focus:outline-none w-1/2">
                    </div>
                    ...
                    <div class="flex items-center justify-between bg-gradient-to-r from-[#c17551]/10 to-transparent border border-[#c17551]/30 rounded-2xl p-4 mt-4 focus-within:border-[#c17551] transition-colors">
                        <span class="text-2xl font-black text-[#c17551]">JOD</span>
                        <input type="number" x-model="jod" @input="usd = (jod * 1.41).toFixed(2)" class="bg-transparent border-none text-right rtl:text-left text-3xl font-black text-[#c17551] focus:outline-none w-1/2">
                    </div>
    ...
    <footer class="bg-[#0a0504] border-t border-white/5 pt-16 pb-8 relative overflow-hidden z-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
