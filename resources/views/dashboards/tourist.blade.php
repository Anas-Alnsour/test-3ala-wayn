        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-10 relative">
            ...
            <div x-show="activeTab === 'overview'" x-transition x-cloak>
                <div class="max-w-3xl">
                    ...
                    <div class="relative ltr:pl-8 rtl:pr-8 ltr:border-l rtl:border-r border-dynamic/30 space-y-10">
                        <div class="relative">
                            <div class="absolute ltr:-left-10 rtl:-right-10 top-0 w-4 h-4 rounded-full bg-dynamic shadow-[0_0_10px_var(--dynamic-primary)] border-2 border-dynamic-main"></div>
                            <div class="text-dynamic text-sm font-bold mb-1">09:00 AM</div>
                            <div class="solid-panel p-5 border border-gray-800 hover:border-dynamic/50 transition-colors bg-dynamic-sidebar">
                        ...
                        <div class="relative">
                            <div class="absolute ltr:-left-10 rtl:-right-10 top-0 w-4 h-4 rounded-full bg-gray-600 border-2 border-dynamic-main"></div>
            ...
            <div x-show="activeTab === 'wishlist'" x-transition x-cloak>
                ...
                <div class="cities-grid">
                    ...
                    <div class="solid-panel rounded-2xl overflow-hidden group cursor-pointer border border-gray-800 hover:border-dynamic transition-colors relative bg-dynamic-sidebar">
                        <button class="absolute top-3 ltr:right-3 rtl:left-3 z-10 w-8 h-8 rounded-full bg-black/50 text-white hover:bg-red-600 transition-colors flex items-center justify-center border border-white/20 backdrop-blur-sm cursor-pointer" @click.stop="$el.closest('.solid-panel').remove(); showToast('Removed from wishlist', 'تمت الإزالة من المفضلة')">
            ...
            <div x-show="activeTab === 'tools'" x-transition x-cloak>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="solid-panel p-8 border-t-4 border-dynamic bg-dynamic-sidebar">
                        <div class="flex items-center gap-4 mb-6">
                            <div class="w-12 h-12 rounded-full bg-dynamic/20 flex items-center justify-center text-dynamic shadow-[0_0_15px_color-mix(in_srgb,var(--dynamic-primary)_30%,transparent)]">
                        ...
                        <div class="space-y-6">
                            <div class="bg-dynamic-main border border-gray-700 rounded-xl p-4 flex items-center shadow-inner">
                    ...
                    <div class="solid-panel p-8 border-t-4 border-red-500 relative overflow-hidden bg-dynamic-sidebar">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="space-y-4">
                                <button @click="callEmergency" class="w-full bg-red-600 hover:bg-red-700 text-white p-4 rounded-xl font-bold text-lg flex items-center justify-between transition-colors cursor-pointer border-none shadow-lg hover:shadow-[0_5px_15px_rgba(220,38,38,0.4)]">
                                    ...
                                    <span class="opacity-50 text-sm font-normal">CALL</span>
                                </button>

                                <button @click="callEmergency" class="w-full bg-dynamic-main border border-gray-700 hover:border-gray-500 text-white p-4 rounded-xl font-bold text-lg flex items-center justify-between transition-colors cursor-pointer shadow-md">
                                    <div class="flex items-center gap-3">
